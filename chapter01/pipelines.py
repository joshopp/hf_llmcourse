...
#                     "You are like League of Legends."
#                     ])
# print(clas_result)
...
# gen_result = generator(["You should quit playing League of Legends because", "you should start playing LoL because"], num_return_sequences=2, max_new_tokens=25)
