This is a standard README for any model card when uploading own models:
...
Further examples here: https://github.com/huggingface/model_card/blob/master/examples.md